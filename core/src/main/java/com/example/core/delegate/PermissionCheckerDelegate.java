...
import com.example.core.ui.camera.CameraImageBean;
import com.example.core.ui.camera.LatteCamera;
import com.example.core.ui.camera.RequestCodes;
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                ...
                case RequestCodes.PICK_PHOTO:
                    Log.e("pickPhoto","uri:null");

                    if (data != null) {
                        final Uri pickPath = data.getData();
                        Log.e("pickPhoto","uri:"+pickPath.toString());
